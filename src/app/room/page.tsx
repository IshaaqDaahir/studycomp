                ...
                <div className="container">
                    ...
                    <div className="room">
                        ...
                        <div className="room__header scroll">
                            ...
                            <p>Hosted By</p>
                            <Link href="/profile" className="room__author">
                                <div className="avatar avatar--small">
                                    <Image src={avatar} alt="Room Host Avatar" />
                                </div>
                        ...
                        <div className="room__conversation">
                            ...
                            {/* {% for message in room_messages %} */}
                                ...
                                <div className="thread__top">
                                    ...
                                    <Link href="/profile" className="thread__authorInfo">
                                        <div className="avatar avatar--small">
                                            <Image src={avatar} alt="Message User Avatar" />
                                        </div>
                                        <span>@Message Username</span>
                                    </Link>
                                    <span className="thread__date">Message created|time ago</span>
                                    </div>
                    ...
                    <div className="participants">
                        <h3 className="participants__top">Participants <span>(10 Joined)</span></h3>
                        <div className="participants__list scroll">

                        {/* {% for user in participants %} */}
                            <Link href="/profile" className="participant">
